...
import { getUsers, postUser, leaveForm, updateLeaveStatus, fetchLeaveRequests, fetchAttendance, fetchEmployeesCard, postemployee, deleteEmployee, fetchEmployeespayslip} from "../model/userDB.js"
...
const postUsersCon = async(req,res)=>{
    ...
    res.json({
        message:'You have registered succefully'
    })
}
...
const postLeaveCon = async (req, res) => {
  try {
    ...
    console.error("Server Error in postLeaveCon:", err); // 🧠 This will tell us the real issue
...
export {getUsersCon, postUsersCon, postLeaveCon, updateLeaveStatusCon,fetchLeaveRequestsCon,fetchAttendanceCon,fetchEmployeesCardCon, postemployeeCon, deleteEmployeeCon, fetchEmployeespayslipCon}   
